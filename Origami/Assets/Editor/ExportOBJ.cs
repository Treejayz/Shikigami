...
//Used to export game objects (specifically level objects) to OBJ files that can be brought into Maya
//Taken from Unify Community, authors DaveA, HeliHlodversson, tgraupmann, drobe
